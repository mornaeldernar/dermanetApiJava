...
class SpecialityControllerTest {
    ...
    void createTest() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/speciality").accept(MediaType.APPLICATION_JSON).content(exampleJson).contentType(MediaType.APPLICATION_JSON);
    ...
    void findTest() throws Exception{
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/speciality/1").accept(MediaType.APPLICATION_JSON);
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
